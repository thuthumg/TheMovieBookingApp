package com.padcmyanmar.ttm.themoviebookingapp.horizontalcarousel
...
class HorizontalCarouselRecyclerView(
    ...
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.whiteDark10) }
        ...
        viewsToChangeColor.forEach { viewId ->
            ...
            when (viewToChangeColor) {
                is ImageView -> {
                    ...
                    //viewToChangeColor.foreground = getDrawable(context,R.drawable.background_card_gradient)
                }
//                is TextView -> {
